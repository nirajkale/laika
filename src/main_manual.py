...
if __name__ == "__main__":
    ...
    camera_yaw = JoystickAccumulator(
        name="RIGHT_X",
    ...
    camera_pitch = JoystickAccumulator(
        name="RIGHT_Y",
        transform_to_int=True,
        min_val=-10,
        max_val=10,
    ...
    rt = JoystickAxisControl(
        name="RT", transform_to_int=True, min_val=100, max_val=0
    )  # 100 instead of 180 because we're updating duty cycle not angle
